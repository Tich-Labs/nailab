...
# Use OmniAuth for Google OAuth2 authentication [https://github.com/zquestz/omniauth-google-oauth2]
gem "omniauth-google-oauth2"

# Use OmniAuth for LinkedIn OAuth2 authentication [https://github.com/decioferreira/omniauth-linkedin-oauth2]
