...
ActiveRecord::Schema[8.1].define(version: 2025_12_27_192814) do
  ...
  create_table "baseline_plans", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_baseline_plans_on_user_id"
  end
  ...
  create_table "partner_applications", force: :cascade do |t|
    ...
    t.bigint "user_id"
    t.string "website"
    t.index ["user_id"], name: "index_partner_applications_on_user_id"
  end
  ...
  add_foreign_key "baseline_plans", "users"
