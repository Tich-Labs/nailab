class ApplicationController < ActionController::Base
  ...
  before_action :redirect_to_onboarding_if_needed, unless: :devise_controller_or_active_admin?
  before_action :store_return_to, if: :devise_controller?
  protect_from_forgery with: :exception

  private

  def devise_controller_or_active_admin?
    devise_controller? || params[:controller].to_s.start_with?("admin/")
  end
