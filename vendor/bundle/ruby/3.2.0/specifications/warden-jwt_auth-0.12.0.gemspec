# -*- encoding: utf-8 -*-
# stub: warden-jwt_auth 0.12.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<dry-auto_inject>.freeze, [">= 0.8", "< 2"])
  s.add_runtime_dependency(%q<dry-configurable>.freeze, [">= 0.13", "< 2"])
  s.add_runtime_dependency(%q<jwt>.freeze, [">= 2.1", "< 4"])
